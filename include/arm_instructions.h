...
typedef enum {
  INSTRUCTION_DATA_PROC,                               // Data processing
  INSTRUCTION_MULTIPLY,                                // Multiply
  INSTRUCTION_MULTIPLY_LONG,                           // Multiply long
  INSTRUCTION_SINGLE_DATA_SWAP,                        // Single data swap
  INSTRUCTION_BRANCH_AND_EXCHANGE,                     // Branch and exchange
  INSTRUCTION_HALFWORD_DATA_TRANSFER_REGISTER_OFFSET,  // Halfword data transfer
                                                       // (register offset)
  INSTRUCTION_HALFWORD_DATA_TRANSFER_IMMEDIATE_OFFSET, // Halfword data transfer
                                                       // (immediate offset)
  INSTRUCTION_SINGLE_DATA_TRANSFER,                    // Single data transfer
  INSTRUCTION_UNDEFINED,                               // Undefined instruction
  INSTRUCTION_BLOCK_DATA_TRANSFER,                     // Block data transfer
  INSTRUCTION_BRANCH,                                  // Branch
  INSTRUCTION_COPROCESSOR_DATA_TRANSFER,     // Coprocessor data transfer
  INSTRUCTION_COPROCESSOR_DATA_OP,           // Coprocessor data processing
  INSTRUCTION_COPROCESSOR_REGISTER_TRANSFER, // Coprocessor register transfer
  INSTRUCTION_SOFTWARE_INTERRUPT,            // Software interrupt
...
typedef struct {
  ...
  ARMinstruction_type_t
      type; // classify instruction (data proc, branch, load/store, etc.)
